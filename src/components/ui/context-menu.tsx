...
/**
 * Right-click menu. Styled to match `dropdown-menu.tsx` exactly — Base UI
 * ships the primitive but the shadcn registry configured here doesn't carry a
 * context-menu recipe, so this wraps the same parts by hand.
 */
